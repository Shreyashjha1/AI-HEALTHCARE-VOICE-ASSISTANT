...
⚠️ Safety Layer blocks risky queries (diagnosis, prescriptions, drugs).

🔊 Voice Output via Web Speech API (Text‑to‑Speech).

📜 Disclaimer: Provides general guidance only, not medical diagnosis.
...
Low‑literacy populations needing simple voice interaction
...
Ethics: No diagnosis/prescriptions

Privacy: Local browser only, no data stored
...
Expand to multilingual support (English/Hindi).
